    ...
    return function(t) {
        ...
        , function(t, e, o) {
            ...
            i.extend(r.prototype, {
                ...
                show: function(t) {
                    ...
                    var e = this.__popup
                        , o = this.__backdrop;
                    if (this.__activeElement = this.__getActive(),
                            this.open = !0,
                            this.follow = t || this.follow,
                            !this.__ready) {
                        if (e.addClass(this.className).attr("role", this.modal ? "alertdialog" : "dialog").css("position", this.fixed ? "fixed" : "absolute"),
                            a || i(window).on("resize", i.proxy(this.reset, this)),
                                this.modal) {
                            var n = {
                                position: "fixed",
                                left: 0,
                ...
                focus: function() {
                    ...
                    if (o && o !== this && o.blur(!1),
                            !i.contains(t, this.__getActive())) {
                        var a = e.find("[autofocus]")[0];
                        !this._autofocus && a ? this._autofocus = !0 : a = t,
                            this.__focus(a)
                    }
                ...
                removeEventListener: function(t, e) {
                    for (var o = this.__getEventListener(t), r = 0; r < o.length; r++)
                        e === o[r] && o.splice(r--, 1);
                    return this
                },
                ...
                __follow: function(t) {
                    var e = t.parentNode && i(t)
                        , o = this.__popup;
                    if (this.__followSkin && o.removeClass(this.__followSkin),
                            e) {
                        var r = e.offset();
                        if (r.left * r.top < 0)
                    ...
                    i.each(T, function(t, e) {
                        L[t][e] > C[P[e]][1] && (e = T[t] = U[e]),
                        L[t][e] < C[P[e]][0] && (T[t] = U[e])
                    }),
                    T[1] || (P[T[1]] = "left" === P[T[0]] ? "top" : "left",
                        L[1][T[1]] = S[P[T[1]]]),
                        B += T.join("-") + " " + this.className + "-follow",
                        n.__followSkin = B,
                    e && o.addClass(B),
                        R[P[T[0]]] = parseInt(L[0][T[0]]),
                        R[P[T[1]]] = parseInt(L[1][T[1]]),
                        o.css(R)
                },
                __offset: function(t) {
                    var e = t.parentNode
        ...
        , function(t, e, o) {
            ...
            var r = o(0)
                ...
                "string" != typeof t && 1 !== t.nodeType || (t = {
                    ...
                    t = r.extend(!0, {}, p.defaults, t),
                    t.original = i;
                var n = t.id = t.id || s + a
                    , u = p.get(n);
                return u ? u.focus() : (l || (t.fixed = !1),
                t.quickClose && (t.modal = !0,
                    t.backdropOpacity = 0),
                r.isArray(t.button) || (t.button = []),
                void 0 !== o && (t.cancel = o),
            ...
            p.create = function(t) {
                ...
                t.quickClose && n.on("onmousedown"in document ? "mousedown" : "click", function() {
                ...
                r.extend(c, {
                    ...
                    button: function(t) {
                        ...
                        return this.callbacks = {},
                            "string" == typeof t ? (o = t,
                                i++) : r.each(t, function(t, n) {
                                var a = n.id = n.id || n.value
                                    , s = "";
                                e.callbacks[a] = n.callback,
                                    n.display === !1 ? s = ' style="display:none"' : i++,
                                    o += '<button type="button" i-id="' + a + '"' + s + (n.disabled ? " disabled" : "") + (n.autofocus ? ' autofocus class="ui-dialog-autofocus"' : "") + ">" + n.value + "</button>",
                                    e._$("button").on("click", "[i-id=" + a + "]", function(t) {
        ...
        , function(t, e, o) {
                ...
                for (var o = 0; o < t.length; o++) {
                    ...
                    if (i) {
                        ...
                        for (; n < r.parts.length; n++)
                            i.parts.push(l(r.parts[n], e))
                    } else {
                        for (var a = [], n = 0; n < r.parts.length; n++)
                            a.push(l(r.parts[n], e));
                        d[r.id] = {
                            id: r.id,
                            refs: 1,
                            parts: a
            ...
            function n(t, e) {
                ...
                var r = m[m.length - 1];
                if ("top" === t.insertAt)
                    r ? r.nextSibling ? o.insertBefore(e, r.nextSibling) : o.appendChild(e) : o.insertBefore(e, o.firstChild),
                        m.push(e);
                else {
            ...
            function l(t, e) {
                ...
                if (e.singleton) {
                    ...
                    t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (o = u(e),
                            r = c.bind(null, o, e),
                            i = function() {
                                a(o),
            ...
            function c(t, e, o) {
                ...
                (e.convertToAbsoluteUrls || n) && (r = _(r)),
                        ...
                        return e.toString = function() {
                            ...
                            e.i = function(t, o) {
                                ...
                                for (i = 0; i < t.length; i++) {
                                    var a = t[i];
                                    "number" == typeof a[0] && r[a[0]] || (o && !a[2] ? a[2] = o : o && (a[2] = "(" + a[2] + ") and (" + o + ")"),
                                        e.push(a))
                                }
                            }
                            ,
        ...
        , function(t, e) {
            e.read = function(t, e, o, r, i) {
                var n, a, s = 8 * i - r - 1, u = (1 << s) - 1, f = u >> 1, l = -7, p = o ? i - 1 : 0, h = o ? -1 : 1, c = t[e + p];
                for (p += h,
                         n = c & (1 << -l) - 1,
                         c >>= -l,
                         l += s; l > 0; n = 256 * n + t[e + p],
                         p += h,
                         l -= 8)
                    ;
                for (a = n & (1 << -l) - 1,
                         n >>= -l,
                         l += r; l > 0; a = 256 * a + t[e + p],
                         p += h,
                         l -= 8)
                    ;
                if (0 === n)
                ...
                e.write = function(t, e, o, r, i, n) {
                    var a, s, u, f = 8 * n - i - 1, l = (1 << f) - 1, p = l >> 1, h = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, c = r ? 0 : n - 1, d = r ? 1 : -1, g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                    for (e = Math.abs(e),
                             isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0,
                                 a = l) : (a = Math.floor(Math.log(e) / Math.LN2),
                             e * (u = Math.pow(2, -a)) < 1 && (a--,
                                 u *= 2),
                                 e += a + p >= 1 ? h / u : h * Math.pow(2, 1 - p),
                             e * u >= 2 && (a++,
                                 u /= 2),
                                 a + p >= l ? (s = 0,
                                     a = l) : a + p >= 1 ? (s = (e * u - 1) * Math.pow(2, i),
        ...
        , function(t, e, o) {
            ...
            function n(t) {
                ...
                for (e = 0,
                    ...
                    n = l[t.charCodeAt(e)] << 18 | l[t.charCodeAt(e + 1)] << 12 | l[t.charCodeAt(e + 2)] << 6 | l[t.charCodeAt(e + 3)],
                        ...
                        s[f++] = n >> 8 & 255,
                        s[f++] = 255 & n;
                return 2 === a ? (n = l[t.charCodeAt(e)] << 2 | l[t.charCodeAt(e + 1)] >> 4,
                    s[f++] = 255 & n) : 1 === a && (n = l[t.charCodeAt(e)] << 10 | l[t.charCodeAt(e + 1)] << 4 | l[t.charCodeAt(e + 2)] >> 2,
                        s[f++] = n >> 8 & 255,
                        s[f++] = 255 & n),
                    s
            }
            ...
            function s(t, e, o) {
                for (var r, i = [], n = e; n < o; n += 3)
                    r = (t[n] << 16) + (t[n + 1] << 8) + t[n + 2],
                        i.push(a(r));
                return i.join("")
            }
            function u(t) {
                for (var e, o = t.length, r = o % 3, i = "", n = [], a = 16383, u = 0, l = o - r; u < l; u += a)
                    n.push(s(t, u, u + a > l ? l : u + a));
                return 1 === r ? (e = t[o - 1],
                    i += f[e >> 2],
                    i += f[e << 4 & 63],
                    i += "==") : 2 === r && (e = (t[o - 2] << 8) + t[o - 1],
                        i += f[e >> 10],
                        i += f[e >> 4 & 63],
                        i += f[e << 2 & 63],
                        i += "="),
            ...
            e.byteLength = i,
                e.toByteArray = n,
                e.fromByteArray = u;
            for (var f = [], l = [], p = "undefined" != typeof Uint8Array ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = 0, d = h.length; c < d; ++c)
                f[c] = h[c],
                    l[h.charCodeAt(c)] = c;
            l["-".charCodeAt(0)] = 62,
                l["_".charCodeAt(0)] = 63
            ...
            (function(t) {
                    ...
                    function c(t, e, o, r) {
                        ...
                        return e = void 0 === o && void 0 === r ? new Uint8Array(e) : void 0 === r ? new Uint8Array(e,o) : new Uint8Array(e,o,r),
                            a.TYPED_ARRAY_SUPPORT ? (t = e,
                                t.__proto__ = a.prototype) : t = h(t, e),
                            t
                    }
                    function d(t, e) {
                        if (a.isBuffer(e)) {
                            var o = 0 | g(e.length);
                            return t = n(t, o),
                                0 === t.length ? t : (e.copy(t, 0, 0, o),
                                    t)
                        }
                        if (e) {
                            if ("undefined" != typeof ArrayBuffer && e.buffer instanceof ArrayBuffer || "length"in e)
                                return "number" != typeof e.length || Q(e.length) ? n(t, 0) : h(t, e);
                    ...
                    function m(t, e, o, r, i) {
                        ...
                        if ("string" == typeof e && (e = a.from(e, r)),
                                a.isBuffer(e))
                            return 0 === e.length ? -1 : _(t, e, o, r, i);
                        if ("number" == typeof e)
                            return e &= 255,
                        ...
                        for (var r = [], i = e; i < o; ) {
                            ...
                            if (i + s <= o) {
                                ...
                                switch (s) {
                                    ...
                                    case 2:
                                        u = t[i + 1],
                                        128 == (192 & u) && (p = (31 & n) << 6 | 63 & u) > 127 && (a = p);
                                        break;
                                    case 3:
                                        u = t[i + 1],
                                            f = t[i + 2],
                                        128 == (192 & u) && 128 == (192 & f) && (p = (15 & n) << 12 | (63 & u) << 6 | 63 & f) > 2047 && (p < 55296 || p > 57343) && (a = p);
                                        break;
                                    case 4:
                                        u = t[i + 1],
                                            f = t[i + 2],
                                            l = t[i + 3],
                                        128 == (192 & u) && 128 == (192 & f) && 128 == (192 & l) && (p = (15 & n) << 18 | (63 & u) << 12 | (63 & f) << 6 | 63 & l) > 65535 && p < 1114112 && (a = p)
                                }
                            }
                            null === a ? (a = 65533,
                                s = 1) : a > 65535 && (a -= 65536,
                    ...
                    function P(t) {
                        ...
                        for (var o = "", r = 0; r < e; )
                            o += String.fromCharCode.apply(String, t.slice(r, r += tt));
                        return o
                    }
                    function L(t, e, o) {
                        var r = "";
                    ...
                    function I(t, e, o) {
                        for (var r = t.slice(e, o), i = "", n = 0; n < r.length; n += 2)
                            i += String.fromCharCode(r[n] + 256 * r[n + 1]);
                        return i
                    }
                    function M(t, e, o) {
                        if (t % 1 != 0 || t < 0)
                    ...
                    function Y(t, e, o, r) {
                        e < 0 && (e = 65535 + e + 1);
                        for (var i = 0, n = Math.min(t.length - o, 2); i < n; ++i)
                            t[o + i] = (e & 255 << 8 * (r ? i : 1 - i)) >>> 8 * (r ? i : 1 - i)
                    }
                    function N(t, e, o, r) {
                        e < 0 && (e = 4294967295 + e + 1);
                        for (var i = 0, n = Math.min(t.length - o, 4); i < n; ++i)
                            t[o + i] = e >>> 8 * (r ? i : 3 - i) & 255
                    }
                    ...
                    function X(t, e) {
                        for (var o, r, i, n = [], a = 0; a < t.length && !((e -= 2) < 0); ++a)
                            o = t.charCodeAt(a),
                                r = o >> 8,
                                i = o % 256,
                                n.push(i),
                    ...
                    function J(t, e, o, r) {
                        for (var i = 0; i < r && !(i + o >= e.length || i >= t.length); ++i)
                            e[i + o] = t[i];
                        return i
                    }
                    function Q(t) {
                    ...
                    "undefined" != typeof Symbol && Symbol.species && a[Symbol.species] === a && Object.defineProperty(a, Symbol.species, {
                        ...
                        a.prototype.inspect = function() {
                            ...
                            return this.length > 0 && (t = this.toString("hex", 0, o).match(/.{2}/g).join(" "),
                            this.length > o && (t += " ... ")),
                            "<Buffer " + t + ">"
                        }
                        ,
                        a.prototype.compare = function(t, e, o, r, i) {
                            ...
                            if (void 0 === e && (e = 0),
                                ...
                                e < 0 || o > t.length || r < 0 || i > this.length)
                    ...
                    a.prototype.slice = function(t, e) {
                        ...
                        a.prototype.readUIntLE = function(t, e, o) {
                            t |= 0,
                                e |= 0,
                            o || M(t, e, this.length);
                            for (var r = this[t], i = 1, n = 0; ++n < e && (i *= 256); )
                                r += this[t + n] * i;
                            return r
                        }
                        ,
                        ...
                        a.prototype.readIntBE = function(t, e, o) {
                            t |= 0,
                                e |= 0,
                            o || M(t, e, this.length);
                            for (var r = e, i = 1, n = this[t + --r]; r > 0 && (i *= 256); )
                                n += this[t + --r] * i;
                            return i *= 128,
                        ...
                        a.prototype.writeInt32LE = function(t, e, o) {
                            return t = +t,
                                e |= 0,
                            o || O(this, t, e, 4, 2147483647, -2147483648),
                                a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t,
                                    this[e + 1] = t >>> 8,
                                    this[e + 2] = t >>> 16,
                        ...
                        a.prototype.copy = function(t, e, o, r) {
                            ...
                            if (this === t && o < e && e < r)
                                ...
                                Uint8Array.prototype.set.call(t, this.subarray(o, o + n), e);
                            return n
                        }
                        ,
        ...
        , function(t, e, o) {
            var r = o(0)
                ...
                , c = function() {
                this.start = r.proxy(this.start, this),
                    this.over = r.proxy(this.over, this),
                    this.end = r.proxy(this.end, this),
                    this.onstart = this.onover = this.onend = r.noop
            };
            c.types = p,
                c.prototype = {
                    start: function(t) {
                        return t = this.startFix(t),
                            n.on(p.over, this.over).on(p.end, this.end),
                            this.onstart(t),
                            !1
                    },
                    over: function(t) {
                        ...
                        return t = this.endFix(t),
                            n.off(p.over, this.over).off(p.end, this.end),
                            this.onend(t),
                            !1
                    },
                    startFix: function(t) {
                        return t = h(t),
                            this.target = r(t.target),
                            this.selectstart = function() {
                                return !1
                            }
                            ,
                            n.on("selectstart", this.selectstart).on("dblclick", this.end),
                            f ? this.target.on("losecapture", this.end) : i.on("blur", this.end),
                    ...
                    endFix: function(t) {
                        return t = h(t),
                            ...
                            f ? this.target.off("losecapture", this.end) : i.off("blur", this.end),
                        l && this.target[0].releaseCapture(),
                            t
                    }
                },
                c.create = function(t, e) {
                    var o, a, s, u, f = r(t), l = new c, p = c.types.start, h = function() {}, d = t.className.replace(/^\s|\s.*/g, "") + "-drag-start", g = {
                        onstart: h,
                        onover: h,
                        onend: h,
                        off: function() {
                    ...
                    return l.onstart = function(e) {
                        ...
                        o = 0,
                            a = 0,
                            s = r ? i.width() - h + o : n.width() - h,
                            u = r ? i.height() - c + a : n.height() - c;
                        var b = f.offset()
                        ...
                        l.onover = function(e) {
                            var r = e.clientX - this.clientX + this.startLeft
                                ...
                                , n = f[0].style;
                            r = Math.max(o, Math.min(s, r)),
                                i = Math.max(a, Math.min(u, i)),
                                n.left = r + "px",
                                n.top = i + "px",
                                g.onover.call(t, e, r, i)
                        }
                        ,
                        l.onend = function(e) {
                            var o = f.position()
            ...
            i.oncreate = function(t) {
                ...
                if (a && (this.padding = o.padding = 0,
                        ...
                        e.attr({
                            ...
                            r && (o.width || t.width(e.contents().width()),
                            o.height || t.height(e.contents().height())),
                            s && s.call(t)
                        }),
                ...
                i.get = function(t) {
                    if (t && t.frameElement) {
                        ...
                        for (var n in r)
                            if (e = r[n],
                                e.node.getElementsByTagName("iframe")[0] === o)
                                return e
                    } else if (t)
                        return i.list[t]
                }
